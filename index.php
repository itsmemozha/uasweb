...
?>
  ...
  include "navbar.php";
    ...
    include "opt_login.php";
     ?>
           ...
           <div class="w3-container w3-center " >
             <img src="assets/futsal/backgriund.jpg" alt="Image">
    ...
    <div class="container w3-center" style="max-width:auto; margin-top:20px">
      <div class="w3-row">
    ...
    <?php
        ...
        <div class="border border-5 mx auto" style="margin-top:-10px;" >
         <?php
    $batas = 3;
    ...
    <div class="w3-container w3-card-2 w3-white w3-round" style="margin-left: 10px; margin-top:10px;"><br>
              ...
              <div class="w3-row-padding" style="margin:0 -16px">
                <div class="w3-half">
                  <img src="operator/assets/foto_lap/<?php echo $r['foto']; ?>" style="width:60%; min-height:60%;" alt="Northern Lights" class="w3-margin-bottom">
                </div>
