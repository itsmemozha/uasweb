...
<html lang="en">
  ...
  <link rel="shortcut icon" href="../assets/images/ikon.png">
    ...
    <title>Futsal Kita || Administration </title>
        ...
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title"><img src="../assets/images/ikon.png" style="width:30px; height:30px;"> <span>Futsal Kita</span></a>
            </div>
